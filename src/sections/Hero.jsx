  ...
  return (
    <>
         ...
         <h1 data-aos="zoom-in" className="text-2xl text-black font-semibold">
          ...
          <div data-aos="slide-up" id='icon-list' className="flex flex-col justify-center items-start gap-6">
            ...
            <div id='icon-box' className="flex justify-center items-center gap-3">
              ...
              <h1 className="text-xl text-gray-800 font-semibold">+91 879 987 0912 / +91 162 7819 8298</h1>
            </div>
            <div id='icon-box' className="flex justify-center items-center gap-3">
      ...
      <div data-aos='zoom-in' data-aos-delay="200" className="flex flex-col justify-center items-center gap-4" >
        ...
        <button className="px-10 py-3 bg-black text-white text-md font-semibold rounded-xl hover:bg-themeyellow hover:text-black cursor-pointer">More</button>
      </div>
      <div data-aos='zoom-in' data-aos-delay="200" className="flex flex-col justify-center items-center gap-4" >
      ...
      <div data-aos='zoom-in' data-aos-delay="200" className="flex flex-col justify-center items-center gap-4" >
        ...
        <button className="px-10 py-3 bg-black text-white text-md font-semibold rounded-xl hover:bg-themeyellow hover:text-black cursor-pointer">More</button>
      </div> <div data-aos='zoom-in' data-aos-delay="200" className="flex flex-col justify-center items-center gap-4" >
